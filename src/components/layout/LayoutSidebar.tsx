...
export const LayoutSidebar: React.FC = () => {
  ...
  return (
    <aside
      className="hidden h-full w-72 flex-col border-r border-neutral-200 bg-white/90 px-4 py-6 backdrop-blur dark:border-neutral-800 dark:bg-neutral-900/70 lg:flex"
